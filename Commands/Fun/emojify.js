...
module.exports = {
    name: "emojify",
    aliases: ["emoji"],
    description: "Emojifie ton text!!",
    example: `${config.Prefix}emojify Salut`,
    category: "Fun",

    run: async (client, message, args) => {

        if(!args[0]) return message.reply(`${emoji.Error} Fournir un texte à émojifier !!`)
        ...
        if(!msg) return message.reply(`${emoji.Error} Impossible d'émojifier **${args[0]}**`)
