...
module.exports = {
    name: "waifu",
    category: "Image",
    description: "Envoie un anime waifu aléatoire à partir de reddit",
    ...
    run: async (client, message, args) => {
        ...
        if (!channel)
        return message.reply(`${emoji.Error} Veuillez vous assurer que la commande est exécutée dans un canal nsfw !!`)
