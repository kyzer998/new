...
module.exports = {
    name: "bonk",
    category: "Image",
    description: "Fait une image de bonk !!",
    ...
    run: async (client, message, args) => {
        ...
        if (!user)
        return message.reply(`${emoji.Error} Fournir un utilisateur à bonk \`${config.Prefix}bonk <User>\``)
        ...
        bonk.getBuffer(`image/jpeg`, (err, buffer) => {
            ...
            const embed = new Discord.MessageEmbed()
              ...
              .setTitle(`${message.author.username} a bonk ${user.user.username} !!`)
              .attachFiles(bonked)
